    ...
    <div>
      ...
      <q-dialog v-model="verVal" persistent>
        <q-card v-if="error" style="border-radius: 24px;" class="column">
          ...
          <div class="column items-center q-pa-lg">
            ...
            <div class="row">
              ...
              <div class="text-h6">{{slide === hojas.length ? 'para poder completar el examen' : 'para pasar a las sigientes preguntas.'}}</div>
            </div>
          </div>
        ...
        <q-card v-else style="border-radius: 24px;" clickable>
          ...
          <div class="text-center text-h6 q-px-lg q-pt-lg q-pb-xl">{{slide === hojas.length ? 'Felicidades haz completado el examen con éxito' : 'Te estamos redirecionando a la siguientes preguntas.'}}</div>
        </q-card>
      </q-dialog>
    </div>
  </div>
